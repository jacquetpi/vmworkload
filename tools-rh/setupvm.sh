...
case $4 in
  "idle" | "stressng" | "dsb")
    image="/mnt/pi/disk5/qcow2/baseline-ubuntu20-04.qcow2"
    ;;

  "wordpress")
    image="/mnt/pi/disk5/qcow2/baseline-ubuntu20-04-wp.qcow2"
    ;;

  "tpcc")
    image="/mnt/pi/disk5/qcow2/baseline-ubuntu20-04-tpcc.qcow2"
    ;;

  "tpch")
    image="/mnt/pi/disk5/qcow2/baseline-ubuntu20-04-tpch.qcow2"
    ;;
